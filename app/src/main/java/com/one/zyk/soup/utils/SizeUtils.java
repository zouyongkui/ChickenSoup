...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = SoupApp.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = SoupApp.getInstance().getResources().getDisplayMetrics().scaledDensity;
