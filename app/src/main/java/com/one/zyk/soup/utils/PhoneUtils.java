...
public final class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm =
                (TelephonyManager) SoupApp.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getPhoneStatus() {
        ...
        if (tm == null) return "";
        String str = "";
        str += "DeviceBrand = " + android.os.Build.BRAND + "\n";
        str += "DeviceModel = " + android.os.Build.MODEL + "\n";
    ...
    public static void dial(final String phoneNumber) {
        SoupApp.getInstance().startActivity(IntentUtils.getDialIntent(phoneNumber, true));
    }
    ...
    public static void call(final String phoneNumber) {
        SoupApp.getInstance().startActivity(IntentUtils.getCallIntent(phoneNumber, true));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        SoupApp.getInstance().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content, true));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(SoupApp.getInstance(), 0, new Intent(), 0);
    ...
    public static void getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = SoupApp.getInstance().getContentResolver();
